...
type RoleBindingsServer interface {
	...
	List(request *RoleBindingsListServerRequest, response *RoleBindingsListServerResponse) error

	// Add handles a request for the 'add' method.
	//
	// Creates a new role binding.
	Add(request *RoleBindingsAddServerRequest, response *RoleBindingsAddServerResponse) error
...
func (r *RoleBindingsListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *RoleBindingsAddServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
