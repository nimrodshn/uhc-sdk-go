...
type RegistriesServer interface {
	...
	List(request *RegistriesListServerRequest, response *RegistriesListServerResponse) error
...
func (r *RegistriesListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
