...
type AccountServer interface {
	...
	Get(request *AccountGetServerRequest, response *AccountGetServerResponse) error

	// Update handles a request for the 'update' method.
	//
	// Updates the account.
	Update(request *AccountUpdateServerRequest, response *AccountUpdateServerResponse) error
}
...
func (r *AccountGetServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *AccountUpdateServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
