...
type PermissionsServer interface {
	...
	List(request *PermissionsListServerRequest, response *PermissionsListServerResponse) error

	// Add handles a request for the 'add' method.
	//
	// Creates a new permission.
	Add(request *PermissionsAddServerRequest, response *PermissionsAddServerResponse) error
...
func (r *PermissionsListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *PermissionsAddServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
