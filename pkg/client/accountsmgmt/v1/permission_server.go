...
type PermissionServer interface {
	...
	Get(request *PermissionGetServerRequest, response *PermissionGetServerResponse) error

	// Delete handles a request for the 'delete' method.
	//
	// Deletes the permission.
	Delete(request *PermissionDeleteServerRequest, response *PermissionDeleteServerResponse) error
}
...
func (r *PermissionGetServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *PermissionDeleteServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
