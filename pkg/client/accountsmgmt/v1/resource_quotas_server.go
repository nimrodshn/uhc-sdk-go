...
type ResourceQuotasServer interface {
	...
	List(request *ResourceQuotasListServerRequest, response *ResourceQuotasListServerResponse) error

	// Add handles a request for the 'add' method.
	//
	// Creates a new resource quota.
	Add(request *ResourceQuotasAddServerRequest, response *ResourceQuotasAddServerResponse) error
...
func (r *ResourceQuotasListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *ResourceQuotasAddServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
