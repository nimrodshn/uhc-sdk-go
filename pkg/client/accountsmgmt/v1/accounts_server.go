...
type AccountsServer interface {
	...
	List(request *AccountsListServerRequest, response *AccountsListServerResponse) error

	// Add handles a request for the 'add' method.
	//
	// Creates a new account.
	Add(request *AccountsAddServerRequest, response *AccountsAddServerResponse) error
...
func (r *AccountsListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
...
// GetContext returns the request Context and
// a flag indicating if the parameter has a value.
func (r *AccountsAddServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
