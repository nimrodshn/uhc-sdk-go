...
type DashboardsServer interface {
	...
	List(request *DashboardsListServerRequest, response *DashboardsListServerResponse) error
...
func (r *DashboardsListServerRequest) GetContext() (value context.Context, ok bool) {
	ok = r != nil && r.ctx != nil
	if ok {
		value = r.ctx
	}
